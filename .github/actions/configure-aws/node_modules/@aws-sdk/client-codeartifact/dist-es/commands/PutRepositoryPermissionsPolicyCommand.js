...
import { de_PutRepositoryPermissionsPolicyCommand, se_PutRepositoryPermissionsPolicyCommand, } from "../protocols/Aws_restJson1";
export { $Command };
export class PutRepositoryPermissionsPolicyCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutRepositoryPermissionsPolicyCommand.getEndpointParameterInstructions()));
